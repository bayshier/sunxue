...
>
> 颖学：笑点在前，痛点在后。深情不直说，让一个荒诞的实物替你说——冻鸡、100 度的椰子鸡、15688 条消息。想让人心疼你，用孙学；想让人又笑又心疼，用颖学。
...
**三层孙学（终版）**：文本层是被割的文笔（败者修辞学）；系统层是赢学的生意（被割 → 流量 → 诉讼筹码）；修行层是破戒的代价——**被割不是孙学失败，是教主违规**（给彩礼、谈七年、要代孕，条条踩门规）。学孙学，别学孙哥。——曾颖讲义"孙学的本质是赢学"全文收录。
...
│   ├── SKILL.md             # 心法 + 六条技法 + 孙颖对照表（词源：孙宇晨亲自命名）
│   └── references/corpus.md # 曾颖四篇文章全文语料 + 颖学词源帖
└── assets/                  # 宣传图 + 语料截图
```
